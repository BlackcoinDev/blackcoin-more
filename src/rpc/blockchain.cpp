...
UniValue blockheaderToJSON(const CBlockIndex& tip, const CBlockIndex& blockindex)
{
    ...
    result.pushKV("flags", strprintf("%s", blockindex.IsProofOfStake()? "proof-of-stake" : "proof-of-work")); // BLACKCOIN-SPECIFIC: include flags
    result.pushKV("modifier", blockindex.nStakeModifier.GetHex()); // BLACKCOIN-SPECIFIC: include modifier
