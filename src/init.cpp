...
"current working directory '%s'. This is fragile, because if blackmore is started in the future "
"from a different location, it will be unable to locate the current data files. There could "
"also be data loss if blackmore is started while in a temporary directory.\n",
