    ...
    return RPCHelpMan{
        ...
        RPCResult{
            ...
            {{
                ...
                {RPCResult::Type::STR_AMOUNT, "total_balance", "The total balance (trusted + untrusted_pending + immature + stake)"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue {
            ...
            obj.pushKV("total_balance", ValueFromAmount(bal.m_mine_trusted + bal.m_mine_untrusted_pending + bal.m_mine_immature + bal.m_mine_stake));
