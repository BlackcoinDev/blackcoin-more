...
BOOST_AUTO_TEST_CASE(initial_advertise_from_version_message)
{
    ...
    const auto msg_version =
        NetMsg::Make(PROTOCOL_VERSION, NetMsgType::VERSION, services, time, services, CAddress::V1_NETWORK(peer_us));
    ...
    const auto msg_verack = NetMsg::Make(PROTOCOL_VERSION, NetMsgType::VERACK);
